...
UA = "Mozilla/5.0 (compatible; ResearchDesk/0838)"
...
LIVE_SEATS = {"CRCLUSDT"}  # ONE OPEN only; XAU flat — pulse CRCL only, never a candidate
FORCE_RECHECK = set()
...
# Fetch all candidate rechecks + CRCL HOLD (XAU flat — not live)
...
# --- LIVE HOLD/CLOSE pulse CRCL only (XAU flat) ---
LIVE_META = {
    "CRCLUSDT": {
        "side": "LONG", "entry": 89.17, "size": 1.36, "order": 1099123376,
        "close_px": 91.39925, "margin_note": "5% Operator-instructed; sole live open (XAU flat 07:22 BST)",
    },
}
live_holds = {}
